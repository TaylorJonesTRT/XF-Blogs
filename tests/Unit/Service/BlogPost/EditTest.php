...
class EditTest extends TestCase
{
    ...
    protected function createService(array $blogPostValues = [])
    {
        ...
        return new Edit($this->app(), $blogPost);
    }
    ...
    {
        $service = $this->createService();
        $this->assertInstanceOf(BlogPost::class, $service->blogPost);
    }
    ...
    {
        $blogPost = $this->makeBlogPost();
        $service = new Edit($this->app(), $blogPost);

        $this->assertInstanceOf(Edit::class, $service);
