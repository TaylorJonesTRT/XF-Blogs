...
class BlogPost extends Entity implements RenderableContentInterface, DatableInterface
{
    ...
    protected function verifyBlogPostTitle(&$value)
    {
        if (strlen($value) < 10)
        {
        ...
        {
            $this->error(\XF::phrase('taylorj_blogs_blog_post_title_length_reached', ['length' => \XF::options()->taylorjBlogsBlogPostTitleLength]));
            return false;
        }
    ...
    public static function getStructure(Structure $structure): Structure
    {
        ...
        $structure->columns = [
            ...
            'blog_post_title' => ['type' => self::STR, 'maxLength' => 300, 'required' => true, 'censor' => true],
